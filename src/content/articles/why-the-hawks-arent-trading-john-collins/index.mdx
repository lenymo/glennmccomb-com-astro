...
import Tweet from "../../../components/shortcodes/Tweet.astro";
...
<small>
  Photo by [Ronny
  Sison](https://unsplash.com/@ronnysison?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
  on
  [Unsplash](https://unsplash.com/s/photos/atlanta?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText).
</small>
